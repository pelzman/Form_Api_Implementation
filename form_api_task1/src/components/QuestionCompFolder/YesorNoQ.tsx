...
const YesorNoQ = ({ initialData, handleInputChange }: Partial<Props>) => {
    ...
    <div>
      ...
      <div className="flex justify-start items-center gap-2 mt-[34px]">
        <label className="inline-flex items-center cursor-pointer">
          {initialData ?
            <input type="checkbox" name="other" className="cursor-pointer" checked={initialData.other}
              onChange={(e) => handleInputChange && handleInputChange(e, 0)}
            />
            :

            <input type="checkbox" name="other" className="cursor-pointer" />
          }
